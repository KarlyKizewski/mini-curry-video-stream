...
sub setContent()
  ...
  m.Image.uri="pkg:/images/plating-curry.png"
  ContentNode = CreateObject("roSGNode", "ContentNode")
  ContentNode.streamFormat = "mp4"
  ContentNode.url = "https://youtu.be/hV3Z_RBbtHQ"
  ContentNode.ShortDescriptionLine1 = "Can we cook in miniature?"
  ContentNode.Description = "Using real food, Miniature Space prepares and cooks curry and rice from scratch. All utensils are dollhouse size and fully functional."
  ContentNode.StarRating = 80
  ContentNode.Length = 1972
  ContentNode.Title = "Miniature Space makes the beloved Japanese Curry"
  ...
  m.Title.text = "Miniature Space makes the beloved Japanese Curry"
  m.Details.text =  "Using real food, Miniature Space prepares and cooks curry and rice from scratch. All utensils are dollhouse size and fully functional."
